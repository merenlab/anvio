...
## Usage:
# Rscript enrichment_script_flexible_input.R --input input.txt --output output.txt

## Examples:
# Rscript enrichment_script_flexible_input.R --input Functional_enrichment_input_file_five_groups_with_enriched_groups_column.txt --output five-group-out.txt
# Rscript enrichment_script_flexible_input.R --input Functional_enrichment_input_file_two_groups_with_enriched_groups_column.txt --output two-group-out.txt
