...
def main(args):
    ...
    output_file_path = A('output') or '%s.vcf' % (str(input_file_path))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='A script to convert SNV output obtained from anvi-gen-variability-profile \
