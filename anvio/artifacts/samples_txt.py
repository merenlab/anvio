...
class SamplesTxt:
    ...
    # Valid lr_technology values. These map to LongQC sample types and minimap2 presets
    # via LR_TECHNOLOGY_MAP in anvio/workflows/__init__.py.
    VALID_LR_TECHNOLOGIES = {'ont', 'pb-rs2', 'pb-sequel', 'pb-hifi'}
