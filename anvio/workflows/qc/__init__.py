"""
    QCModule — a mixin providing quality-control steps for short-read workflows.
"""
...
class QCModule(WorkflowSuperClass):
    """Mixin providing SR quality-control steps reusable across workflows.
    ...
    def get_fastq(self, readset, pre_ref_removal=False):
        ...
        For LR: returns raw LR files (no filtering yet).
        For SR: delegates to _resolve_sr_path().
        """
