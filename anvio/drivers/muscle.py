...
class Muscle:
    ...
    def run_default(self, sequences_list, debug=False):
        ...
        if additional_params:
            if self.major_version == 5 and '-super5' in additional_params:
    ...
    def get_major_version(self):
        ...
        raise ConfigError("The anvi'o MUSCLE driver currently supports MUSCLE 3 and MUSCLE 5, but failed to "
                          "recognize the installed MUSCLE version from `muscle -version` output: %s" % output)
