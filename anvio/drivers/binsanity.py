...
class BinSanity:
    ...
    def cluster(self, input_files, args, work_dir, threads=1, log_file_path=None):
        ...
        cmd_line = [
            self.program_name,
            "-c",
            input_files.contig_coverages_log_norm,
            "-f",
            os.path.dirname(input_files.contigs_fasta),
            "-l",
            os.path.basename(input_files.contigs_fasta),
            "-o",
            work_dir,
        ...
        for bin_file in output_file_paths:
            ...
            with open(bin_file, "r") as f:
                ...
                clusters[pretty_bin_name] = [
                    line.strip().replace(">", "") for line in f if line.startswith(">")
                ]
