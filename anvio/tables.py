...
variable_aas_table_structure         = ['entry_id', 'sample_id', 'corresponding_gene_call', 'codon_order_in_gene', 'consensus', 'departure_from_consensus', 'coverage'] + sorted(list(set(codon_to_AA.values())))
