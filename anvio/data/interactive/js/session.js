...
function showUserOptions (user) {
    ...
    html += '<img src="images/user.png" style="width: 32px; border-radius: 3px; margin-left: 10px;"><span style="margin-left: 10px;">logged in as '+user.firstname+' '+user.lastname+' ('+session.user.login+')</span>';
    html += '</div>';
