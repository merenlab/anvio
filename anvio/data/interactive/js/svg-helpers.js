...
async function drawInlineScaleBar(settings) {
    ...
    try {
        ...
        if ((settings['tree-type'] == 'circlephylogram' || settings['tree-type'] == 'phylogram')) {
            //drawRectangle('scale_inline_bar', 50, 50, 80, 300, 'white', 1, 'black');
            ...
            line.setAttribute('x2', scaleBarLength * 5);
            line.setAttribute('y2', 30);
            var svg = document.getElementById('scale_inline_bar');
            svg.appendChild(line);
            ...
            divElement.appendChild(svgWrapper);
            
            document.getElementById('items-data-section').appendChild(divElement);
