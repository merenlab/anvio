...
def migrate(db_path):
    ...
    pan_db.set_meta_value('items_ordered', pan_db.get_meta_value('gene_clusters_ordered'))
    ...
    run.info_single('Your pan db is now %s (lucky you).' % next_version, nl_after=1, nl_before=1, mc='green')
