...
def migrate(db_path):
    ...
    pan_db._exec('ALTER TABLE "item_additional_data" ADD COLUMN "data_group" text')
    pan_db._exec('ALTER TABLE "layer_additional_data" ADD COLUMN "data_group" text')

    pan_db._exec('UPDATE "item_additional_data" SET "data_group" = "default"')
    pan_db._exec('UPDATE "layer_additional_data" SET "data_group" = "default"')
