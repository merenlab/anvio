...
def migrate(db_path):
    ...
    if is_blank:
        run.info_single(
            f"Your blank profile-db is immune to this update, so anvi'o simply bumped its "
        ...
        run.info_single(
            f"The profile database is now {next_version}. We recently added a parameter for "
