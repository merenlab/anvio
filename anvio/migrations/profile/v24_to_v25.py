...
variable_codons_table_structure = [
    "entry_id",
    "sample_id",
...
def migrate(db_path):
    ...
    if is_full_profile:
        ...
        profile_db._exec(
            "ALTER TABLE variable_nucleotide_positions RENAME TO variable_nucleotides;"
        )
    ...
    if full_upgrade:
        run.info_single(
            "Your profile db is now version %s. If you had amino acids profiled for this database,\
