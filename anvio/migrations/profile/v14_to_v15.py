...
def migrate(db_path):
    ...
    run.info_single(
        "Database successfully upgraded to version 15!",
        nl_after=1,
        nl_before=1,
        mc="green",
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="A simple script to upgrade profile database to from version 14 version 15"
    )
    parser.add_argument(
        "profile_db", metavar="PROFILE_DB", help="Profile database (of version 14)"
    )
