...
def migrate(db_path):
    ...
    if str(contigs_db.get_version()) != current_version:
        raise ConfigError(
            f"The version of the provided contigs database is {contigs_db.get_version()}, "
    ...
    if db_altered:
        message = (
            f"Your contigs database is now version {next_version}. Sadly this update removed all SCG taxonomy "
        ...
        message = (
            "Since you have already updated your contigs-db with new SCGs, anvi'o simply bumped the version of your "
