...
def migrate(db_path):
    ...
    contigs_db.create_table(
        t.hmm_hits_table_name, t.hmm_hits_table_structure, t.hmm_hits_table_types
    )
    contigs_db.create_table(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="A simple script to upgrade contigs database from version %s to version %s"
