...
def migrate(db_path):
    ...
    contigs_db.create_table(nucleotide_additional_data_table_name, nucleotide_additional_data_table_structure, nucleotide_additional_data_table_types)
    contigs_db.create_table(amino_acid_additional_data_table_name, amino_acid_additional_data_table_structure, amino_acid_additional_data_table_types)
