...
ANVIO_ITEMS = {'pan-db': 'PAN DB',
               ...
               'concatenated-gene-alignment-fasta': 'CONCATENATED GENE ALIGNMENT FASTA',
               'short-reads-fasta': 'SHORT READS FASTA',
               'genes-fasta': 'GENES FASTA',
               'bam-file': 'BAM FILE',
               'raw-bam-file': 'RAW BAM FILE',
               ...
               'hmm-source': 'HMM SOURCE',
               'cogs-data': 'COGS DATA',
               'pfams-data': 'PFAMS DATA',
               'hmm-profile': 'HMM PROFILE',
               'misc-data-items-txt': 'ITEMS DATA TXT',
               'misc-data-items': 'ITEMS DATA',
               'misc-data-layers-txt': 'LAYERS DATA TXT',
               'misc-data-layers': 'LAYERS DATA',
               'misc-data-layers-category': 'LAYERS DATA CATEGORY',
               'misc-data-layer-orders': 'LAYER ORDERS DATA',
               'misc-data-layer-orders-txt': 'LAYER ORDERS DATA TXT',
               'dendrogram': 'DENDROGRAM NEWICK',
               'metapangenome': 'METAPANGENOME',
               'oligotypes': 'OLIGOTYPES',
               'linkmers-txt': 'LINKMERS TXT',
               'phylogeny': 'PHYLOGENY NEWICK',
               'gene-calls-txt': 'GENE CALLS TXT',
               'functions': 'GENE FUNCTIONS',
               'functions-txt': 'FUNCTIONS TXT',
               'functional-enrichment-txt': 'ENRICHED FUNCTIONS TXT',
               'interactive': 'INTERACTIVE DISPLAY',
               'view-data': 'VIEW DATA TXT',
               'layer-taxonomy': 'LAYER TAXONOMY',
               'layer-taxonomy-txt': 'LAYER TAXONOMY TXT',
               'gene-taxonomy': 'GENE TAXONOMY',
               'gene-taxonomy-txt': 'GENE TAXONOMY TEXT',
               'external-genomes': 'EXTERNAL GENOMES TXT',
               'internal-genomes': 'INTERNAL GENOMES TXT',
               'ani': 'ANI ESTIMATES',
               'variability-profile': 'VARIABILITY PROFILE',
               'codon-frequencies-txt': 'CODON FREQUENCIES TXT',
               'aa-frequencies-txt': 'AA FREQUENCIES TXT',
