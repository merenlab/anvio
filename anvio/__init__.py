...
D = {
    ...
    'trnaseq-contigs-db': (
            ...
            {'metavar': 'TRNASEQ_CONTIGS_DB',
             'required': True,
             'help': "Anvi'o `trnaseq`-variant contigs database generated by 'anvi-merge-trnaseq'."}
                ),
    'runinfo': (
            ['-r', '--runinfo'],
    ...
    'compute-gene-level-normalized-coverages': (
            ...
            {'default': False,
             ...
             'help': "When this flag is used in gene mode, anvi'o will compute five normalizations of "
                     ...
                     "(2) cpm: coverage per million mapped reads, which accounts for differences in "
                     ...
                     "of log1p-transformed values; (5) zscore_cpm: per-gene z-score of cpm-normalized "
