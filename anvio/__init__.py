...
D = {
    ...
    'metagenomes': (
            ['-M', '--metagenomes'],
            {'metavar': 'FILE_PATH',
             'help': "A two- to five-column TAB-delimited flat text file. The header line must contain at least these columns: "
                     "'name' and 'contigs_db_path', but may also contain the following columns: 'profile_db_path', 'collection_name', "
                     "and 'metagenome_mode'. Each line should list a single entry, where 'name' "
                     "can be any name to describe the metagenome stored in the anvi'o contigs database. For SCG taxonomy "
                     "context, the anvi'o profiles associated with contigs database must be SINGLE PROFILES, as in "
                     "generated by the program `anvi-profile` and not `anvi-merge`. For KEGG metabolism context, any anvi'o profiles "
                     "are acceptable."}
                ),
    'gene-caller': (
            ['--gene-caller'],
