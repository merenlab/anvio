...
D = {
    ...
    'flank-mode': (
            ...
            {'action': 'store_true',
             'help':
             "If in --flank-mode, anvi-export-locus will extract a locus based on the coordinates \
    ...
    'num-genes': (
            ...
            {'metavar': 'NUM_GENES',
             'type': str,
             'help':
             "Required for DEFAULT mode. For each match (to the function, or HMM that was searched) a sequence which includes \
