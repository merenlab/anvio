...
#FIXME for some reason I cannot make a pangenome here. There is a config error with filepath
# issues the boggle my mind
...
INFO "Testing anvi-analyze-synteny now with COG annotation source"
anvi-analyze-synteny -g $output_dir/TEST-GENOMES.db \
                     --annotation-source COG_FUNCTION \
                     --ngram-window-range 2:3 \
