...
class MetaPangenome(object):
    ...
    def get_gene_presence_in_the_environment_dict(self):
        ...
        for profile_db_path in self.unique_profile_db_path_to_internal_genome_name:
            ...
            for internal_genome_name in self.unique_profile_db_path_to_internal_genome_name[profile_db_path]:
                bin_id = self.descriptions.genomes[internal_genome_name]['bin_id']
                ...
                detection_across_metagenomes = summary.collection_profile[bin_id]['detection']
                ...
                gene_presence_in_the_environment_dict[bin_id] = {}
                ...
                genome_bin_summary = summarizer.Bin(summary, bin_id, split_names_of_interest)
                ...
                for gene_caller_id in sum_gene_coverages_across_samples:
                    ...
                    gene_presence_in_the_environment_dict[bin_id][gene_caller_id] = _class
