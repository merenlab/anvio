...
class TableForContigsInfo:
    ...
    def append(self, seq_id, sequence, gene_start_stops=None):
        ...
        split_start_stops = utils.get_split_start_stops(
            sequence_length, self.split_length, gene_start_stops
        )
    ...
    def append(self, seq_id, sequence, order, start, end, parent_gc_content, parent):
        ...
        db_entry = tuple(
            [
                ...
                sequence_length,
                utils.get_GC_content_for_sequence(sequence),
                parent_gc_content,
                parent,
            ]
        )
