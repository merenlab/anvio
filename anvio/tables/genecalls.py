...
class TablesForGeneCalls(Table):
    ...
    def populate_genes_in_splits_tables(self):
        ...
        database.db._exec_many('''INSERT INTO %s VALUES (?,?,?,?)''' % t.genes_in_splits_summary_table_name, db_entries)
        ...
        database.db._exec_many('''INSERT INTO %s VALUES (?,?,?,?,?,?)''' % t.genes_in_splits_table_name, db_entries)
