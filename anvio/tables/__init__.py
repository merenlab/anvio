...
trnaseq_trimmed_table_structure         = ['name', 'unique_seq_count', 'read_count', 'id_info', 'sequence', 'normalized_seq_representation', 'fiveprime_unique_seq_count', 'fiveprime_read_count'] + [threeprime_variant + '_read_count' for threeprime_variant in THREEPRIME_VARIANTS]
trnaseq_trimmed_table_types             = ['str' , 'numeric'         , 'numeric'   , 'str'    , 'str'     , 'numeric'                      , 'numeric'                   , 'numeric'             ] + ['numeric' for _ in THREEPRIME_VARIANTS]
...
trnaseq_normalized_table_types          = ['str' , 'numeric'          , 'str'    , 'numeric'               , 'numeric'                  , 'str'               , 'str'                  , 'numeric'                    , 'numeric'            , 'numeric'               , 'numeric'                                     , 'numeric'                                        , 'numeric'                   , 'numeric'                      , 'str'                                 , 'str'                                            , 'str'                                    , 'str'                                               ] + ['numeric' for _ in THREEPRIME_VARIANTS                                                  ] + ['numeric' for _ in THREEPRIME_VARIANTS]
