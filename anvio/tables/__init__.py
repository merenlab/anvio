...
versions_for_db_types = {
    "contigs": contigs_db_version,
...
pan_gene_clusters_table_structure = [
    "gene_caller_id",
    "gene_cluster_id",
    "genome_name",
    "alignment_summary",
...
pan_reaction_network_reactions_table_structure = [
...
pan_reaction_network_reactions_table_types = [
    "text",
    "text",
    "text",
    "text",
...
genes_in_contigs_table_structure = [
    "gene_callers_id",
    "contig",
    "start",
    "stop",
...
gene_function_calls_table_structure = [
    "gene_callers_id",
    "source",
    "accession",
    "function",
...
reaction_network_reactions_table_structure = [
    "modelseed_reaction_id",
    "modelseed_reaction_name",
    "ko_kegg_reaction_source",
    "ko_ec_number_source",
...
reaction_network_reactions_table_types = [
    "text",
    "text",
    "text",
    "text",
...
splits_taxonomy_table_structure = [
    "split",
    "taxon_id",
]
splits_taxonomy_table_types = [
    "text",
    "numeric",
]

genes_taxonomy_table_name = "genes_taxonomy"
genes_taxonomy_table_structure = [
    "gene_callers_id",
    "taxon_id",
]
genes_taxonomy_table_types = [
    "numeric",
    "numeric",
]
...
hmm_hits_info_table_types = [
    "text",
    "text",
    "text",
    "text",
    "text",
]  # This one here is the id that apper as in gene_calls table
#         /
hmm_hits_table_name = "hmm_hits"  # _______|_______
hmm_hits_table_structure = [
    "entry_id",
    "source",
...
hmm_hits_splits_table_structure = [
    "hmm_hit_entry_id",
    "split",
    "percentage_in_split",
    "source",
...
gene_level_coverage_stats_table_structure = [
    "gene_callers_id",
    "sample_name",
    "mean_coverage",
    "detection",
...
gene_level_coverage_stats_table_types = [
    "numeric",
    "text",
    "numeric",
    "numeric",
...
gene_level_inseq_stats_table_structure = [
    "gene_callers_id",
    "sample_name",
    "mean_coverage",
    "insertions",
...
gene_level_inseq_stats_table_types = [
    "numeric",
    "text",
    "numeric",
    "numeric",
...
trna_seed_feature_table_structure = (
    ["gene_callers_id"]
    + list(
        itertools.chain(
            *zip(
...
trna_seed_feature_table_types = (
    ["gene_callers_id"]
    + ["str"] * len(TRNA_FEATURE_NAMES[:-1]) * 2
...
collections_info_table_structure = [
    "collection_name",
    "num_splits",
    "num_bins",
    "bin_names",
...
collections_bins_info_table_structure = [
    "collection_name",
    "bin_name",
    "source",
    "html_color",
...
genome_info_table_structure = [
    "genome_name",
    "genome_hash",
    "external_genome",
] + essential_genome_info
genome_info_table_types = ["str", "text", "numeric"] + ["numeric"] * len(
    essential_genome_info
)

gene_info_table_name = "gene_info"
gene_info_table_structure = [
    "genome_name",
    "gene_caller_id",
    "aa_sequence",
    "dna_sequence",
...
genome_gene_function_calls_table_structure = [
    "genome_name",
] + gene_function_calls_table_structure[:]
genome_gene_function_calls_table_types = [
    "str",
] + gene_function_calls_table_types[:]
...
trnaseq_feature_table_structure = (
    [
        "name",
    ...
    + list(
        itertools.chain(
            *zip(
                [f + "_start" for f in TRNA_FEATURE_NAMES],
...
trnaseq_feature_table_types = (
    ...
    + ["str"] * len(TRNA_FEATURE_NAMES) * 2
    + ["numeric", "numeric", "numeric", "numeric"]
)

trnaseq_unconserved_table_name = "unconserved"
trnaseq_unconserved_table_structure = [
    "name",
    "pos",
    "observed_nucleotide",
    "expected_nucleotides",
]
trnaseq_unconserved_table_types = ["str", "numeric", "str", "str"]

trnaseq_unpaired_table_name = "unpaired"
trnaseq_unpaired_table_structure = [
    "name",
    "fiveprime_pos",
    "threeprime_pos",
    "observed_fiveprime_nucleotide",
    "observed_threeprime_nucleotide",
]
...
trnaseq_trimmed_table_structure = [
    ...
    "id_info",
    "sequence",
    "normalized_seq_representation",
    "fiveprime_unique_seq_count",
    "fiveprime_read_count",
    "threeprime_termini",
    "threeprime_terminus_read_counts",
]
trnaseq_trimmed_table_types = [
    "str",
    "numeric",
    "numeric",
    "str",
...
trnaseq_normalized_table_structure = [
    "name",
    "trimmed_seq_count",
    "id_info",
    "mean_specific_coverage",
    "mean_nonspecific_coverage",
    "specific_coverages",
...
trnaseq_normalized_table_types = [
    "str",
    "numeric",
    "str",
    "numeric",
...
trnaseq_modified_table_structure = [
    "name",
    "mean_specific_coverage",
    "mean_nonspecific_coverage",
    "specific_coverages",
    ...
    "consensus_sequence",
    "count_of_normalized_seqs_without_indels",
    "names_of_normalized_seqs_without_indels",
    "count_of_normalized_seqs_with_indels",
...
table_requires_unique_entry_id = {
    "self": False,
    "kmer_contigs": False,
    "kmer_splits": False,
