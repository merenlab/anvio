...
# trnaseq_subseq_derep_table_structure    = ['name', 'normalized_seq_count', 'input_seq_count', 'average_subsequence_multiplicity', 'mapped_threeprime_unique_seq_count', 'mapped_threeprime_input_seq_count', 'mapped_interior_unique_seq_count', 'mapped_interior_input_seq_count', 'mapped_fiveprime_unique_seq_count', 'mapped_fiveprime_input_seq_count'] + [threeprime_variant + '_input_seq_count' for threeprime_variant in THREEPRIME_VARIANTS]
# trnaseq_subseq_derep_table_types        = ['str' , 'numeric'             , 'numeric'        , 'numeric'                         , 'numeric'                           , 'numeric'                          , 'numeric'                         , 'numeric'                        , 'numeric'                          , 'numeric'                         ] + ['numeric' for _ in THREEPRIME_VARIANTS]
