...
trnaseq_modified_table_structure        = ['name', 'substitution_positions', 'deletion_positions', 'consensus_sequence', 'normalized_names', 'normalized_seq_count', 'input_seq_count', 'average_input_seq_multiplicity', 'mapped_input_seq_without_extra_fiveprime_count', 'mapped_input_seq_with_extra_fiveprime_count'] + [threeprime_variant + '_input_seq_count' for threeprime_variant in THREEPRIME_VARIANTS]
trnaseq_modified_table_types            = ['str' , 'str'                   , 'str'               , 'str'               , 'str'             , 'numeric'             , 'numeric'        , 'numeric'                       , 'numeric'                                       , 'numeric'                                    ] + ['numeric' for _ in THREEPRIME_VARIANTS]
