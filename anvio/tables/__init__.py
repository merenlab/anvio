...
pan_graph_nodes_table_structure      = ['node_id', 'node_type', 'region_id', 'gene_cluster_id', 'gene_calls_json', 'synteny_position_json', 'alignment_summary']
pan_graph_nodes_table_types          = [  'str'  ,    'str'   ,  'numeric' ,       'str'      ,       'str'      ,          'str'         ,        'str'       ]
