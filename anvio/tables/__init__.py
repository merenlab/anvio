...
trnaseq_normalized_table_structure      = ['name', 'trimmed_seq_count', 'input_seq_count', 'specific_coverages', 'nonspecific_coverages', 'average_input_seq_multiplicity', 'mapped_trimmed_seq_without_extra_fiveprime_count', 'mapped_input_seq_without_extra_fiveprime_count', 'mapped_trimmed_seq_with_extra_fiveprime_count', 'mapped_input_seq_with_extra_fiveprime_count'] + [threeprime_variant + '_input_seq_count' for threeprime_variant in THREEPRIME_VARIANTS]
trnaseq_normalized_table_types          = ['str' , 'numeric'          , 'numeric'        , 'str'               , 'str'                  , 'numeric'                       , 'numeric'                                         , 'numeric'                                       , 'numeric'                                      , 'numeric'                                    ] + ['numeric' for _ in THREEPRIME_VARIANTS]
