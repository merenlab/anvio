...
class AnvioAuthors:
    def __init__(self, authors_yaml_file_path=os.path.join(os.path.dirname(anvio.__file__), 'data/misc/PEOPLE/AUTHORS.yaml'), skip_init=False, r=terminal.Run(), p=terminal.Progress()):
        self.run = r
        self.progress = p
