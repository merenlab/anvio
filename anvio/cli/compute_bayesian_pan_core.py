...
def get_args():
    ...
    groupC.add_argument('-B', '--num-bootstraps' , metavar = "NUM_BOOTSTRAPS", default = 0, type = int, help = "number of bootstraps run on the partitioning to evaluate it's quality"  )
