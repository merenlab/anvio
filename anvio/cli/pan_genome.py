...
def get_args():
    ...
    groupB = parser.add_argument_group('OUTPUT DATA: WHERE THINGS SHOULD APPEAR?', "If you completely skip this section, anvi'o will put things in reasonable "
    ...
    groupB.add_argument(*anvio.A('intermediate-data-dir'), **anvio.K('intermediate-data-dir'))
    ...
    groupD = parser.add_argument_group('DEFAULT GENE CLUSTER FORMATION: RESOLVING NETWORK', "The second step in this workflow is to use the sequence search results "
    ...
    groupD.add_argument('--minbit', type = float, default = 0.5, metavar = "MINBIT", help = "The minimum minbit value. The minbit heuristic \
    ...
    groupD.add_argument('--mcl-inflation', type = float, default = 2.0, metavar = "INFLATION", help = "MCL inflation parameter, that defines\
    ...
    groupD.add_argument('--min-percent-identity', type = float, default = 0.0, metavar = "PERCENT", help = "Minimum percent identity\
    ...
    groupD.add_argument('--min-occurrence', type = int, default = 1, metavar = 'NUM_OCCURRENCE', help = "Do you not want singletons? You don't?\
    ...
    groupE = parser.add_argument_group('ALTERNATIVE GENE CLUSTER FORMATION: USER-PROVIDED GENE CLUSTERS', "As an alternative approach, you can provide "
    ...
    groupE.add_argument(*anvio.A('gene-clusters-txt'), **anvio.K('gene-clusters-txt'))

    groupF = parser.add_argument_group("GENE CLUSTER CHARACTERIZATION", "Parameters that mostly impact how anvi'o characterizes your gene clusters once "
                                "they are identified. Such as aligning within gene cluster sequences, computing homogeneity indices for them, etc. "
                                "Important stuff.")
    groupF.add_argument('--skip-alignments', default = False, action = 'store_true', help = "By default, anvi'o attempts to align amino acid\
    ...
    groupF.add_argument('--skip-homogeneity', default=False, action='store_true', dest='skip_homogeneity',help="By default, anvi'o attempts to calculate homogeneity\
    ...
    groupF.add_argument('--quick-homogeneity', default=False, action='store_true', dest='quick_homogeneity',help="By default, anvi'o will use a homogeneity\
    ...
    groupG = parser.add_argument_group("OTHERS", "Sweet parameters of convenience.")
    groupG.add_argument(*anvio.A('project-name'), **anvio.K('project-name'))
    groupG.add_argument(*anvio.A('description'), **anvio.K('description'))
    groupG.add_argument(*anvio.A('num-threads'), **anvio.K('num-threads'))

    groupH = parser.add_argument_group("ORGANIZING GENE CLUSTERs", "These are stuff that will change the clustering dendrogram of your gene clusters.")
    groupH.add_argument(*anvio.A('skip-hierarchical-clustering'), **anvio.K('skip-hierarchical-clustering', {'help': "Anvi'o attempts\
    ...
    groupH.add_argument(*anvio.A('enforce-hierarchical-clustering'), **anvio.K('enforce-hierarchical-clustering', {'help': "If you\
                                ...
                                flag."}))
    groupH.add_argument(*anvio.A('distance'), **anvio.K('distance', {'default': None, 'help':
    ...
    groupH.add_argument(*anvio.A('linkage'), **anvio.K('linkage', {'default': None, 'help':
