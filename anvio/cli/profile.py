...
def get_args():
    ...
    groupK.add_argument(*anvio.A('skip-clip-profiling'), **anvio.K('skip-clip-profiling'))
    groupK.add_argument(*anvio.A('min-clip-length'), **anvio.K('min-clip-length'))
    groupK.add_argument(*anvio.A('force-clip-profiling'), **anvio.K('force-clip-profiling'))
