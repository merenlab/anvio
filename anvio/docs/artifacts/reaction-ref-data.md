Reference databases required for %(anvi-reaction-network)s are stored in **directories of downloaded files set up by %(anvi-setup-protein-reference-database)s and %(anvi-setup-kegg-data)s**.
