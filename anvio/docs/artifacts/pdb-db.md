...
A %(pdb-db)s can be created via the program %(anvi-setup-pdb-database)s. Alternatively, a %(pdb-db)s that contains custom structures not found in the [RCSB PDB](https://www.rcsb.org/) can in theory be generated by the user, but anvi'o currently offers no reasonable way of doing this.
