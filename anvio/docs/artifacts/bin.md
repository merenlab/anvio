...
In anvi'o, a bin may represent one or more contigs, or gene clusters, or any item that can be shown in the interactive interface and stored in a %(profile-db)s, %(pan-db)s, or %(genes-db)s.
