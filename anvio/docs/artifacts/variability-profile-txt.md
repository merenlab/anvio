...
In summary, this contains output matrices for your SNVs, SCVs and SAAVs that annotate them with lots of additional infomration. This way, you can interact with that data by running %(anvi-script-snvs-to-interactive)s or incorporate it into your structural analysis when running %(anvi-display-structure)s. 
