This program **annotates genes in your %(contigs-db)s with functions using NCBI's [Clusters of Orthologous Groups (COGs) database](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC102395/).**
