...
{:.notice}
For a simlar program that reports function hits across genomes, see %(anvi-gen-function-matrix)s.
...
{{ codestart }}
anvi-gen-hmm-hits-matrix -i %(internal-genomes)s \
...
{{ codestart }}
anvi-gen-hmm-hits-matrix -e %(external-genomes)s \
                                               --list-hmm-sources
{{ codestop }}
