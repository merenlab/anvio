...
ANVIO_WORKFLOWS = {
    "contigs": {
        ...
        "one_paragraph_summary": (
            "This workflow is useful for converting a bunch of genomes into an anvi'o-compatible "
    ...
    "metagenomics": {
        ...
        "one_paragraph_summary": (
            "This workflow is for anyone who wants to do some high-throughput read recruitment. "
    ...
    "ecophylo": {
        ...
        "one_paragraph_summary": (
            "The ecophylo workflow explores the **eco**logical and **phylo**genetic relationships between a gene family and the environment. "
    ...
    "trnaseq": {
        ...
        "one_paragraph_summary": (
            "The trnaseq workflow takes in raw paired-end sequencing data generated from trna-seq libraries (i.e., the direct sequencing of "
    ...
    "sra-download": {
        ...
        "one_paragraph_summary": (
            "The sra-download workflow automatizes the process of downloading paired-end FASTQ files "
...
THIRD_PARTY_PROGRAMS = {
    ...
    "DIAMOND": {
        "link": "https://uni-tuebingen.de/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/informatik/lehrstuehle/algorithms-in-bioinformatics/software/diamond/"
    },
