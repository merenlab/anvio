...
class GenomeStorage(GenomeDescriptions):
    ...
    def get_functions_and_sequences_dicts_from_contigs_db(self, contigs_db_path, gene_caller_ids=None):
        ...
        return (function_calls_dict, protein_sequences_dict, dna_sequences_dict)
    ...
    def create_genomes_data_storage(self):
        ...
        for genome_name in genome_names_to_go_through:
            ...
            functions_dict, protein_sequences_dict, dna_sequences_dict = self.get_functions_and_sequences_dicts_from_contigs_db(g['contigs_db_path'], g['gene_caller_ids'])
