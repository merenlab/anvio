...
echo "==============================================================================="
echo "TL;DR: If you (1) copy-paste and run the following commands on your terminal"
echo "one after another, (2) close your terminal window after running all five commands,"
echo "and (3) re-activate anvio-dev in a new terminal, everything will continue working"
...
echo ""
echo "    # we start with fixing the script that is invoked during conda activation:"
...
echo ""
echo "    # and finish by fixing the anvi'o Python environment:"
echo "    cd ~/github/anvio"
echo ""
echo "    # please note: when you copy-paste and run the pip command below, your"
echo "    # terminal will be overwhelmed with lots of output messages, which will"
echo "    # push this message out of your vision. So, if you want to read the"
echo "    # rest of this message, do it now, and then copy-pasting and run the pip"
echo "    # command to finalize everything:"
...
echo "are installed as proper commands. Yes, we know, very fancy indeed 🥂"
echo ""
...
echo "problem without having to reinstall \`anvio-dev\` from scratch 😇"
echo ""
