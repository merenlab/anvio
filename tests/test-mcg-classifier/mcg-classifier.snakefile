...
rule run_mcg_classifier:
    ...
    shell: "anvi-mcg-classifier -p {input.profile} -c {input.contigs} -O {params.output_prefix} --outliers-threshold 1.5 --alpha 0.15 --gen-figures --zeros-are-outliers -C TEST -b Bin_1 >> {log} 2>&1"
